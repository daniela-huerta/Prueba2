				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								<div class="media-title font-weight-semibold">Daniela Huerta</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="agregar_departamentos.html" class="nav-link">Agregar departamento</a></li>
								<li class="nav-item"><a href="editar-departamentos.html" class="nav-link">Editar departamentos</a></li>
								<li class="nav-item"><a href="Lista_departamentos.html" class="nav-link">Lista de departamentos</a></li>
							</ul> </li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-bus"></i> <span>Pago de transporte escolar</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item"><a href="editar-alumnos.html" class="nav-link">Editar información de alumnos</a></li>
								<li class="nav-item"><a href="Lista_alumnos.html" class="nav-link">Lista de alumnos</a></li>
						    </ul> </li>

						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-accessibility"></i> <span>Tutorías</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="agregar_tutorias.html" class="nav-link">Agendar tutorías</a></li>
								<li class="nav-item"><a href="editar-tutorias.html" class="nav-link">Editar tutorías</a></li>
								<li class="nav-item"><a href="Lista_tutorias.html" class="nav-link">Lista de tutorías</a></li>
						    </ul> </li>
								<!--
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tutorías</span> - Formulario</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_input_groups.html" class="breadcrumb-item">Tutorías</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p class= "mb-4"> Para agendar una tutoría es necesario llenar el siguiente registro. </p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<legend class="text-uppercase font-size-sm font-weight-bold">Datos del tutor</legend>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Núm. Empleado:</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<legend class="text-uppercase font-size-sm font-weight-bold">Datos de la tutoría</legend>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Tema atendido">
										</div>
									</div>
								</div>
								...
								<div class="form-group row mb-0">
										<div class="col-lg-10 ml-lg-auto text-right">
											...
											<button type="submit" class="btn bg-blue ml-3">Agendar <i class="icon-pencil7"></i></button>
										</div>
								</div>
							</fieldset>
