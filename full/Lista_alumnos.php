			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
                        ...
                        <p> A continuación se muestra el registro de los alumnos.</p>
					...
					<td><button type="button" style ="background: pink" class="btn btn-primary btn-sm"><a href="agregar_alumnos.html">Agregar</a></button></td>
